...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="dashboard.php" class="navbar-brand">
      ...
      <span class="brand-name">YourArchitect</span>
    </a>
  </div><!-- .navbar-header -->
      ...
      <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
        ...
        <li class="dropdown">
          ...
          <div class="media-group dropdown-menu animated flipInY">
            <a href="view-appointment-detail.php?editid={ID&&aptid={APPOINMENT NUNMBER}" class="media-group-item">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <small class="media-meta">{APPOINMENT NUMBER} at ({APPOINTMENT DATE})</small>
                </div>
              </div>
            </a><!-- .media-group-item -->
          </div>
